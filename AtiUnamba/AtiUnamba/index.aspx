<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="AtiUnamba.index1" %>
<!DOCTYPE HTML>
...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="#">
                    <asp:Label ID="lblUsu" runat="server" Text="Label"></asp:Label></span></a></h1>
				<a href="#menuS">Menu</a>
			</header>
